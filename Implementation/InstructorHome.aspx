<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstructorHome.aspx.cs" Inherits="Implementation.InstructorHome" %>
            ...
            <table style="width: 494px" align="center">
                ...
                <tr>
                    <td class="auto-style7">
                        <asp:Button ID="btnAddClass" runat="server" Text="Add Class" Width="100px" PostBackUrl="~/InstructorAddClass.aspx" />
                    &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btbEditProfile" runat="server" Text="Edit Profile" Width="100px" PostBackUrl="~/InstructorEditProfile.aspx" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style8" colspan="2">The classes you are teaching are shown below.<br />
                        Click the magnifying glass to see all the students who has registered for that class.</td>
                </tr>
                <tr>
                        ...
                        <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" EmptyDataText="No Classes Registered" Width="489px" DataKeyNames="CourseName,RegisteredID" Style="text-align: left" AllowSorting="True">
                            <Columns>
                                ...
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="Button1" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" Height="25px" ImageUrl="~/Images/trash.png" Width="25px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
